use strict;
use warnings;
package RT::Extension::ICalTransaction;

our $VERSION = '0.9.0';

=head1 NAME

RT-Extension-ICalTransaction - Human readable iCal attachments

=head1 DESCRIPTION

Parses iCal attachments and display meta data to the user
